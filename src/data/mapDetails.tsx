...
export const MapDetails = {
    ...
    firebaseZ: new MapItem(MapIds.firebaseZ, { title: "Firebase Z" }),
    firebaseZSpawn: new MapItem(MapIds.firebaseZSpawn, { title: "Firebase Z" }),
    mauerDerToten: new MapItem(MapIds.mauerDerToten, { title: "Mauer Der Toten" }),
    mauerDerTotenStreets: new MapItem(MapIds.mauerDerTotenStreets, { title: "Mauer Der Toten" }),
    forsaken: new MapItem(MapIds.forsaken, { title: "Forsaken" }),
    forsakenUnderground: new MapItem(MapIds.forsakenUnderground, { title: "Forsaken" }),
    //onslaught
