...
export const MapDetails = {
    ...
    mauerDerToten: new MapItem(MapIds.mauerDerToten, { title: "Mauer Der Toten Underground" }),
    ...
    forsakenUnderground: new MapItem(MapIds.forsakenUnderground, { title: "Forsaken Underground" }),
    //onslaught
