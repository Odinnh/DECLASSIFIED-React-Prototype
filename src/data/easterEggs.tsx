...
export const EasterEggTypes = {
    mainQuest: new Item({ title: EasterEggStrings.mainQuest, icon: IconFileNames.mainQuest }),
    cassetteTape: new Item({ title: EasterEggStrings.music, icon: IconFileNames.cassette }),
    clue: new Item({ title: EasterEggStrings.clue, icon: IconFileNames.clue }),
    secretArea: new Item({ title: EasterEggStrings.secretArea, icon: IconFileNames.secretArea }),
    interactable: new Item({ title: EasterEggStrings.interactable, icon: IconFileNames.interactable }),
    essenceHarvester: new Item({ title: EasterEggStrings.mauerDerTotenEssenceHarvester, icon: IconFileNames.reactor }),
}
...
export const EasterEggStore: IMisc = {
    ...
    [MapIds.mauerDerToten]: [
        ...
        new MiscMarker("4QpYx", EasterEggTypes.secretArea, [168.43591618416733, 160.56583724877993], "Entrance to Valentina's Lab. Klaus can knock the wall down. Then use the CRBR-S beam mod to open the metal door."),
    ],
