...
export const MiscTypes = {
    ...
    projector: new Item({ title: "Projector", desc: "The projector for the Main Quest", icon: IconFileNames.projector }),
    ...
    wunderFizz: new Item({ title: "Der Wunderfizz", icon: IconFileNames.wunderFizz }),
...
/////////////////////Perks/////////////////////////
export const Perks = {
    staminup: new Item({ id: "staminUp", title: "Stamin-Up", icon: IconFileNames.staminUp }),
    quick: new Item({ id: "quickRevive", title: "Quick Revive", icon: IconFileNames.quickRevive }),
    jugg: new Item({ id: "juggernog", title: "Jugger-Nog", icon: IconFileNames.juggernog }),
    speed: new Item({ id: "speedCola", title: "Speed Cola", icon: IconFileNames.speedCola }),
    mule: new Item({ id: "muleKick", title: "Mule Kick", icon: IconFileNames.muleKick }),
    elemental: new Item({ id: "elementalPop", title: "Elemental Pop", icon: IconFileNames.elementalPop }),
    death: new Item({ id: "deathPerception", title: "Death Perception", icon: IconFileNames.deathPerception }),
    tomb: new Item({ id: "tombstoneSoda", title: "Tombstone", icon: IconFileNames.tombstoneSoda }),
    deadshot: new Item({ id: "deadshotDaiquiri", title: "Deadshot Daiquiri", icon: IconFileNames.deadshotDaiquiri }),
    phd: new Item({ id: "phdSlider", title: "PHD Slider", icon: IconFileNames.phdSlider }),
    meleeMacchiato: new Item({id: 'meleeMacchiato', title: "Melee Macchiato", icon: IconFileNames.meleeMacchiato}),
...
export const MiscStore: IMisc = {
    ...
    [MapIds.libertyFalls]: [ 
        ...
        new MiscMarker("BgXvx", MiscTypes.wallbuy, [155.37139785865875, 288.90258018583415]),
        new MiscMarker("unyje", MiscTypes.wallbuy, [168.31573473300784, 370.0835855753783]),
        new MiscMarker("GIMoK", MiscTypes.wallbuy, [241.74995353941142, 394.23867000110164]),
        new MiscMarker("ycejl", MiscTypes.wallbuy, [304.9780605795013, 279.93780658453477]),
        new MiscMarker("78Nsj", MiscTypes.wallbuy, [240.25637620775572, 331.2362333030811]),
        new MiscMarker("yVyNb", MiscTypes.wallbuy, [266.64290906700586, 301.1046331431583]),
        ...
        new MiscMarker("JtuLa", MiscTypes.trap, [249.61615450344914, 238.02154679560675]),
        new MiscMarker("S03qI", MiscTypes.ammoCrate, [302.34473107606846, 232.83928222676948]),
        new MiscMarker("7RFZM", MiscTypes.ammoCrate, [122.51269656223408, 288.90258018583415]),
        new MiscMarker("ymgVk", MiscTypes.craftingTable, [153.87782052700305, 313.55570758940735]),
        new MiscMarker("rS0yi", MiscTypes.gumball, [195.4490562580858, 311.5635356780075]),
        new MiscMarker("Qv2E4", MiscTypes.gumball, [177.0282691676659, 352.40305986170466]),
        new MiscMarker("DmP2D", MiscTypes.ziplineDown, [203.66373158219196, 430.34678589522406]),
        new MiscMarker("rGb4q", MiscTypes.ammoCrate, [214.1187729037816, 377.8032517320528]),
        new MiscMarker("yKD_3", MiscTypes.mysteryBox, [289.0465690418408, 386.26998235550224]),
        new MiscMarker("6xQ9M", MiscTypes.craftingTable, [262.16217707203884, 334.2244911701809]),
        ...
        new MiscMarker("YVX1t", MiscTypes.door, [220.59094134095616, 297.1202893203586]),
        ...
        new MiscMarker("8Kr_R", MiscTypes.wunderFizz, [267.38969773283367, 308.0772348330578]),
