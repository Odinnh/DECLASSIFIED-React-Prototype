...
export const MiscTypes = {
    dementedEcho: new Item({ title: "Demented Echo", desc: "Destroy it before it touches you to get a reward.", icon: IconTypes.dementedIcon }),
    rift: new Item({ title: "Aether Rift", desc: "Jump through to teleport and gain a random powerup.", icon: IconTypes.riftIcon }),
    redRift: new Item({ title: "Red Aether Rift", desc: "Jump through all the rifts to continue the Easter Egg", icon: IconTypes.redRiftIcon }),
    radio: new Item({ title: "Radio", icon: IconTypes.radioIcon }),
    //TODO STANDARDISE STRING
    requiemRadio: new Item({ title: "Requiem Radio", icon: IconTypes.radioIcon, layer: "Markers" }),
    omegaRadio: new Item({ title: "Omega Radio", icon: IconTypes.radioIcon }),
    maxisRadio: new Item({ title: "Maxis Radio", icon: IconTypes.radioIcon }),
    monkey: new Item({ title: "Stone Monkey", icon: IconTypes.monkeyIcon }),
    projector: new Item({ title: "Projector", desc: "The projector for the Main Quest" }),
    signal: new Item({ title: "Signal" }),
    fishing: new Item({ title: "Fishing", desc: "Fish up to 3 times for a small reward each time.", icon: IconTypes.fishingIcon }),
    ...
    wunderFizz: new Item({ title: "Der Wunderfizz", icon: IconTypes.wunderFizzIcon }),
    trialComputer: new Item({ title: "Trial Computer", icon: IconTypes.trialComputerIcon }),
    papMachine: new Item({ title: "Pack-a-Punch", icon: IconTypes.papMachineIcon }),
    mysteryBox: new Item({ title: "Mystery Box Location", icon: IconTypes.mysteryBoxIcon }),
    wallbuy: new Item({ title: "Wall Buy", icon: IconTypes.wallbuyIcon }),
    ...
    craftingTable: new Item({ title: "Crafting Table", icon: IconTypes.craftingTableIcon }),
    arsenal: new Item({ title: "Arsenal", icon: IconTypes.arsenalIcon }),
    ammoCrate: new Item({ title: "Ammo Crate", icon: IconTypes.ammoCrateIcon }),
    trap: new Item({ title: "Trap" }),
    zipline: new Item({ title: "Zipline", icon: IconTypes.ziplineIcon }),
    rampageInducer: new Item({ title: "Rampage Inducer", icon: IconTypes.dementedIcon }),

    klausRadio: new Item({ title: "Klaus recall radio", icon: IconTypes.radioIcon }),
    aetherTunnel: new Item({ title: "Aether Tunnel", icon: IconTypes.ziplineIcon }),
